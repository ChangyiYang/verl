#!/usr/bin/env bash
# SOFT-PROMPT smoke: same 0.6B setup as verl_opd_smoke_fsdp.sh, plus soft_prompt_num_tokens=16.
#
...
export RAY_TMPDIR=/tmp/ray-cy-sp
mkdir -p "$RAY_TMPDIR"
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=qwen3_0.6b_softprompt \
